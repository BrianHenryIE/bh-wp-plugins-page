...
class Plugins_List_Table_WPUnit_Test extends \Codeception\TestCase\WPTestCase {
    ...
    public function test_row_meta() {
        ...
        $sut->plugin_specific_action_links( array(), $plugin_basename );
    ...
    public function test_ga_google_analytics() {
        ...
        $actions_result = $sut->plugin_specific_action_links( $plugin_actions, $plugin_file );
    ...
    public function test_internal_meta_links_added_to_first_column() {
        ...
        $result = $sut->plugin_specific_action_links( $action_links, $plugin_basename );

        // Check a link with the word Settings is now in the first column.
        $contains_settings =         array_reduce( $result, function( $carry, $element ) {
    ...
    public function test_no_empty_meta() {
        ...
        $sut->plugin_specific_action_links( $action_links, $plugin_basename );
